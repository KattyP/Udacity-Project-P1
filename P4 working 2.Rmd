...
The majority of loans are for debt consolidation. Given such a high proportion of loans are for debt consolidation, not available or other, I won't be focussing on the variable in this analysis.

```{r Listing Category, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Employment Status, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Employment Duration, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Stated Monthly Income, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Stated Montly Income 2, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Income Range, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Debt to Income Ratio, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Loan Status, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Loan Original Amount, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Prosper Rating and Score, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Lender Yield and Borrower Rate, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Estimated Effective Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Loan Timing, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Bivariate Section, echo=FALSE, warning=FALSE, message=FALSE, , fig.height=12, fig.width=12, fig.align='center'}
...
```{r Listing by Income Range, warning=FALSE, error=FALSE}
...
```{r Employment by Risk Rating, message=FALSE, warning=FALSE, , fig.height=12, fig.width=12, fig.align='center'}
...
```{r Employment Status by Prosper Score, echo=FALSE, message=FALSE, warning=FALSE, , fig.height=12, fig.width=12, fig.align='center'}
...
```{r Employment by Loan Status, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8, fig.width=12, fig.align='center'}
...
```{r Income Range by Risk Rating, echo=FALSE, message=FALSE, warning=FALSE, fig.height=12, fig.width=12, fig.align='center'}
...
```{r DTI by Income, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r DTI by Risk Rating, message=FALSE, echo=FALSE, warning=FALSE, fig.height=12, fig.width=12, fig.align='center'}
...
```{r DTI by Loan Status, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8, fig.width=12, fig.align='center'}
...
```{r Loan Status by Prosper Rating, echo=FALSE, message=FALSE, warning=FALSE, fig.height=8, fig.width=12, fig.align='center'}
...
```{r Lender Yield by Year, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Estimated vs Effective Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Income Range by Borrower and Lender Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Employment by Borrower Rate, echo=FALSE, message=FALSE, warning=FALSE, fig.height=12, fig.width=12, fig.align='center'}
...
```{r Rating by Lender Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Income Range by Lender Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r DTI by Lender Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Prosper Rating by Esimated Loss, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
The graphs below show the proportion of defaulted and charged off loans significantly increasing with lender yield.
...
```{r Lender Yield by Loan Status, echo=FALSE, warning=FALSE, fig.height=12, fig.width=12, fig.align='center'}
...
I find it intesting that borrowers who have had an employment status of more than 30 years borrow from Prosper for Debt Consolidation. Although given the vast majority of loans are for Debt Consolidation maybe it is not so surprising.



```{r Employment Duration by Loan Status, echo=FALSE, message=FALSE, warning=FALSE, fig.height=12, fig.width=12, fig.align='center'}

ggplot(aes(x = EmploymentStatusDuration/12), data = subset(loanData, LoanCategory != "NA" & EmploymentCategory != "NA")) +
  geom_histogram(aes(fill = LoanCategory)) +
  xlab("Duration in Years") +
  facet_wrap(~EmploymentCategory, scales = "free_y") +
  scale_fill_discrete(name="Loan Status")

summary(loanData$EmploymentStatusDuration/12)

with(subset(loanData, EmploymentStatusDuration/12 >= 25), table(ListingCategory, EmploymentStatus))
...
```{r Prosper Score by Lender Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r Prosper Rating by Estimated Loss and Borrower Rate, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
**Loans are difficult to estimated when they are high risk**
...
```{r Effective Yield vs Lender Yield, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
**Higher risk loans are more likely to complete**

The graph below is a clear repre
...
ggplot(aes(x = BorrowerRate, y = EstimatedLoss), data = loanData) +
  ...
  scale_fill_continuous(name="Prosper Rating")
